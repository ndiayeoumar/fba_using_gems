...
```{r}
user_data_directory <- "../../data/eae/cd4_old/tpm_counts_normalized"
...
```{r}
if(!file.exists("../../data/eae/cd4_old/eae_cd4_compass_data_mgi.rds")){
    compass_data <- CompassData$new(settings = settings)
    saveRDS(compass_data, 
        file = "../../data/eae/cd4_old/eae_cd4_compass_data_mgi.rds")
} else compass_data <- readRDS("../../data/eae/cd4_old/eae_cd4_compass_data_mgi.rds")
```
